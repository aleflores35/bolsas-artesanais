...
def pag_bg(c,doc):
    ...
    c.setFillColor(MUT); c.setFont('PopL',7.5); c.drawRightString(A4[0]-17*mm,A4[1]-13*mm,'manual de uso · versão 2.14')
...
p('versão 2.14',ParagraphStyle('cv',fontName='PopL',fontSize=9,textColor=GOLD_B,alignment=TA_CENTER))
