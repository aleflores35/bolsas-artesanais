...
def pag_bg(c,doc):
    ...
    c.setFillColor(MUT); c.setFont('PopL',7.5); c.drawRightString(A4[0]-17*mm,A4[1]-13*mm,'manual de uso · versão 2.1')
...
p('versão 2.1',ParagraphStyle('cv',fontName='PopL',fontSize=9,textColor=GOLD_B,alignment=TA_CENTER))
...
passo(6,'Salve. Na tela do projeto ficam <b>Calcular</b>, <b>Produzir</b> e <b>Conferir</b>.')
...
passo(3,'No quadro <b>Sugestão de preço</b>, a mão de obra já vem preenchida; ajuste a margem e toque em "Usar este preço".')
